...
(function($) {
    ...
    Vegas.prototype = {
        _init: function() {
            var $wrapper, $overlay, $timer, isBody = this.elmt.tagName === 'BODY',
            ...
            for (i = 0; i < this.settings.slides.length; i++) {
                ...
                if (this.settings.preload || this.settings.preloadVideos) {
                    if (this.support.video && this.settings.slides[i].video) {
                        if (this.settings.slides[i].video instanceof Array) {} else {}
                    }
                }
            }
        },
        ...
        _goto: function(nb) {
            ...
            this.slide = nb;
            var $slide, $inner, $video, $slides = this.$elmt.children('.vegas-slide'),
            ...
            if (this.support.video && videoSettings) {
                ...
                img = new Image();
                $inner = $('<div class="vegas-slide-inner"></div>').css('background-image', 'url(' + src + ')').css('background-color', color).css('background-position', align + ' ' + valign).css('background-size', cover);
